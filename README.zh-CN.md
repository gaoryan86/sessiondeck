...
| **自动压缩后丢失上下文** | 永久丢失——Claude 会自动压缩长会话 | **Recovery 视图**可读取压缩前的快照 |
...
可以——这是 SessionDeck 的核心功能之一。Recovery 视图可以读取 Claude Code 保留但不在自己界面中展示的压缩前快照数据。
</details>
